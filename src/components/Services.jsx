        ...
        <div className='flex items-center text-center justify-center'>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-[60px]">
             ...
             <div className="justify-center flex lg:justify-start items-center">
                <div className="rounded-xl shadow-xl w-[70px] h-[70px] items-center text-center text-white bg-red-500">
               <VscTerminalUbuntu size={70}/>
               </div>
             </div>

             <div className="flex text-left justify-start mt-[15px] text-[18px] font-bold text-[#0F2137]">Software Development</div>
            ...
            <div className="justify-center flex lg:justify-start items-center">
            <div className="rounded-xl shadow-xl w-[70px] h-[70px] items-center text-center text-white bg-[#eb9737]">
                    <MdOutlineSecurity size={70}/>
            </div>
            </div>

         <div className="flex text-left justify-start mt-[15px] text-[18px] font-bold text-[#0F2137]">Cyber Security</div>
         <div className="text-[15px] font-medium flex text-left justify-start mt-[15px]" style={{lineHeight:1.9}}>
...
<div className="flex text-left justify-start mt-[15px] text-[18px] font-bold text-[#0F2137]">Publishing Service</div>
<div className="text-[15px] font-medium flex text-left justify-start mt-[15px]" style={{lineHeight:1.9}}>
...
<div className="flex text-left justify-start mt-[15px] text-[18px] font-bold text-[#0F2137]">Market Research</div>
<div className="text-[15px] font-medium flex text-left justify-start mt-[15px]" style={{lineHeight:1.9}}>
